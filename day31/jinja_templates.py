...
#     click to guess one of the possible answers. Make sure the answer
#     itself is never sent to the browser. Instead, each user guess is
#     validated on the backend by another endpoint to see whether or not the
#     guess is correct.

#     If it is a correct guess, the UI displays another random trivia
#     question. If it an incorrect guess, the user continues trying to guess
#     the correct answer for a trivia until they guess the correct answer.

#     Use a template to show the trivia question.
